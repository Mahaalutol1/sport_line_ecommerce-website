...
# Database configuration from environment variables or Aiven connection string
def get_db_config():
    ...
    if database_url:
        ...
        return {
            ...
            'ssl_disabled': os.environ.get('DB_SSL', 'false').lower() == 'false'
        }
...
def init_db():
    ...
    try:
        # For production, we assume the database already exists
